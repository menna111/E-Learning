<h5 class="text-yellow text-center">تعديل السؤال</h5>
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input class="form-control input-circle" id="content" type="text" name="content" required value="{{$question->content}}">
                </div>
            </div>
            ...
            <div class="col-6">
                <div class="form-group ">
                    ...
                    <img src="{{render_image($question->image,)}}" alt="{{$question->content}}" title="{{$question->content}}" width="100px" height="100px">
                </div>
            </div>
            <div class="col-6">
                <div class="form-group ">
                    <label class="text-light float-right" for="full_mark">درجة السؤال</label>
                    <input class="form-control dark-input" required type="text" id="full_mark" name="full_mark" value="{{$question->full_mark}}">
                </div>
            </div>
            <div class="col-12">
                <div class="form-group ">
            ...
            <div class="col-12">
                ...
                <div class="form-group ">
                    ...
                    <input id="correct_answer"
                           ...
                           name="correct_answer"
                           type="text"
                           required value="{{$question->answers()->whereIsCorrect(1)->first()->content}}">
                </div>
            </div>
            <div class="col-12">
                <div class="form-group">
            ...
            <div class="col-12">
                <div class="slides-container">
                    @foreach($question->answers()->where('is_correct',0)->get() as $answer);
                            ...
                            <div class="col-10">
                                <div class="form-group">
                                    <input id="answers"
                                           class="form-control input-circle w-98"
                                           name="answers[]"
                                           type="text" required value="{{$answer->content}}">
                                </div>
            ...
            <div class="col-4">
                <button class="btn btn-outline-delete" type="submit"   >حفظ</button>
            </div>
        </div>
    </form>
</div>
